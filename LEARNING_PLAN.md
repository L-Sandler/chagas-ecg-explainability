...
### Resources
- [ECG basics — Life in the Fast Lane](https://litfl.com/ecg-library/) — best free clinical ECG reference, searchable by finding
- Wikipedia article on Chagas disease — covers the biology and epidemiology clearly
- The CODE-15% paper: "Automatic diagnosis of the 12-lead ECG using a deep neural network" (Ribeiro et al., 2020, *Nature Communications*) — this is the paper behind your primary dataset; read the introduction and results sections
...
### Resources
- CODE-15% GitHub: search "Ribeiro 2020 ECG deep learning code" — PyTorch implementation available
- `pytorch-tabnet` is not relevant here; ignore it
- `torchaudio` has useful 1D signal utilities
